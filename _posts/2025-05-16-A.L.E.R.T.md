...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/engine-beginnings.png" alt-text="The engine's starting phase"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/manifest-generator.png" alt-text="The manifest generator tool"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/component-system.png" alt-text="The component system"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/milestone-1.png" alt-text="The engine at the end of milestone 1"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/gui.png" alt-text="The GUI system"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/milestone-2.png" alt-text="The engine by the end of milestone 2"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/tutorial.png" alt-text="The tutorial level in engine"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/main-menu.png" alt-text="The main menu screen"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/intermission.png" alt-text="The intermission screen"/>
<p style="font-size: 13px; text-align: center;"><i>The intermission screen that ranks the user's performance</i></p>

<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/a.l.e.r.t/level-0.5.png" alt-text="Level 0.5"/>
