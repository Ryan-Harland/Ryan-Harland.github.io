...
<div style="position: relative; width: 100%; padding-top: 56.25%; margin-bottom: 10px;">
  <lite-youtube videoid="F7niBfhu1QI" playlabel="A.L.E.R.T Showreel" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></lite-youtube>
</div>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/engine-beginnings.webp" alt="The engine's starting phase"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/manifest-generator.webp" alt="The manifest generator tool"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/component-system.webp" alt="The component system"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/milestone-1.webp" alt="The engine at the end of milestone 1"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/gui.webp" alt="The GUI system"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/milestone-2.webp" alt="The engine by the end of milestone 2"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/tutorial.webp" alt="The tutorial level in engine"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/main-menu.webp" alt="The main menu screen"/>
...
<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/intermission.webp" alt="The intermission screen"/>
<p style="font-size: 13px; text-align: center;"><i>The intermission screen that ranks the user's performance</i></p>

<img class="inline-center" src="{{site.url}}{{site.baseurl}}/assets/img/posts/alert/level-0.5.webp" alt="Level 0.5"/>
